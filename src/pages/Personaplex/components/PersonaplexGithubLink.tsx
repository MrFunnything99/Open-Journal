...
/** Centered repo link (shared by shell footer and in-page footers like About). */
export const PersonaplexGithubLink: FC<{ className?: string }> = ({ className = "" }) => (
  <div className={`flex justify-center text-[10px] text-white/40 ${className}`}>
    <a
